...
D('c03-probability','C03','偶然を繰り返す','50%のコインなら、いつでも半分が表になる？','probability','sample',[N('probability','成功する確率',50,0,100,1,'%'),N('n','試行回数',200,1,1000,1),N('seed','乱数seed',42,1,99)],{scope:'seed固定のBernoulli試行',course:'確率・統計'});
