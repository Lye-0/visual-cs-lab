...
export const lessonShell=['number-input','curriculum-kit','curriculum-tools','curriculum-runtime','player','workbench','reader','experiences-core','experiences-results','experiences-view','live-input','experiences-workspace','notes-visuals','curriculum-visuals','curriculum-rich-visuals','curriculum-demo-visuals'];
